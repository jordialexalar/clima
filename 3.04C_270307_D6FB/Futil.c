...
#include <fexterns.h>
   char *mod[]={"133000","134000","135000","136000","137000"};
...
cal_per = h;
 ...
 veter()
 {
  ...
  borrar();
  for (i=0;i<4;i++)
    say(i+1,0,textos[90+i+idioma_textos]);
...
/*   h=arint(ent);*/
 ...
 int h;
 {
    switch(h)
    {
     ...
     case 2:              /*AGUAS */
       num_codigos=38;
       pos_ini_cod=67+(idioma*128);
       veters=h;
     break;

     case 3:                /*ALIMENTACION */
       num_codigos=23;
       pos_ini_cod=105+(idioma*128);
       veters=h;
       break;
