...
char informe[6400];
    ...
    0x08,0x10,0x20,0x40,0x80};
      ...
      unsigned char linefeed[]={0x09,0x0c,0x06,0x03};
...
if (mascara[h] & informe[(linea*320)+i])
 {
...
{int z;
 ...
 if (z==1)
    {
       borrar();
       say(3,1,textos[62+idioma_textos]);
       inkey(0);
